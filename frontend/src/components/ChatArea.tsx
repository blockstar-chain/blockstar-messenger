            ...
            if (message.type === 'system' || message.isSystemMessage) {
              return (
                <div key={message.id} className="flex justify-center my-4">
                  <div className="flex items-center gap-2 px-4 py-2 bg-surface-light/50 rounded-full border border-border/30">
                    {message.systemMessageType === 'missed_call' && (
                      <>
                        ...
                        <span className="text-sm text-muted">
                          ...
                          {message.metadata?.callerName && ` from ${message.metadata.callerName}`}
                        </span>
                      </>
                    )}
                    {message.systemMessageType === 'call_declined' && (
                      <>
                        ...
                        <span className="text-sm text-muted">
                          {message.callType === 'video' ? 'Video' : 'Voice'} call declined
                        </span>
                      </>
                    )}
                    {message.systemMessageType === 'call_ended' && (
                      <>
                        ...
                        <span className="text-sm text-muted">
                          {message.callType === 'video' ? 'Video' : 'Voice'} call ended
                        </span>
                      </>
                    )}
